...
#### Load the PDB/PQR file
pdb = app.PDBFile('##TEMPLATE')
...
simulation.reporters.append(app.DCDReporter('#TEMPLATE.dcd', 1000))
simulation.reporters.append(app.CheckpointReporter('#TEMPLATE_checkpoint.chk', 1000))
